...
// Implements interface for servarr application

func (r *Radarr) GetAppName() string {
	return "radarr"
}

func (r *Radarr) GetDBNames() []string {
	return []string{
		"radarr-main",
		"radarr-log",
	}
...
func (r *Radarr) GetStatus() *ServarrStatus {
	return &r.Status
}

func (r *Radarr) GetSpec() *ServarrSpec {
	return &r.Spec
}
